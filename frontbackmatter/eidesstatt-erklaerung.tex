...
, dass ich die vorgelegte Arbeit mit dem Titel \makeatletter \emph{\@title} \makeatother% Titel von der Titelseite einfügen
...
\hspace*{100mm} Unterschrift % Unterschrift an die Richtige Stelle setzen
